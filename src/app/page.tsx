    ...
    <main className="relative min-h-[100svh] pt-28 pb-16 text-white">
      ...
      <section className="mt-8 px-5">
        <p className="text-center text-white/65 text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
          ...
          futomaki, hosomaki, california i nigiri na wynos lub z dostawą. Wybierz
          swój lokal, sprawdź menu online i zamów sushi prosto do domu lub do
          pracy. Płatność odbywa się wygodnie gotówką przy dostawie lub
          odbiorze.
        </p>
      </section>
