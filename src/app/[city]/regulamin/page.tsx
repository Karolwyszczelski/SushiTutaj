      ...
      <div className="max-w-3xl mx-auto px-6 pt-28 pb-16">
        <article className="prose prose-invert prose-lg prose-a:text-yellow-300 hover:prose-a:text-yellow-200 prose-hr:border-neutral-700">
          ...
          <ul>
            ...
            <li>
              Serwis nie prowadzi sprzedaży alkoholu ani wyrobów
              tytoniowych.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  podawania prawdziwych i aktualnych danych w procesie
                  rejestracji,
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                <li>
                  Użytkownik narusza postanowienia Regulaminu lub przepisy prawa,
                </li>
                <li>
                ...
                <li>
                  istnieją uzasadnione podejrzenia co do bezpieczeństwa Konta.
                </li>
              </ul>
            ...
            <li>
              ...
              Regulaminie lub korzystając z odpowiedniej funkcji w Serwisie, jeżeli jest dostępna.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  występują obiektywne przeszkody w realizacji (brak produktu,
                  awaria, brak mocy przerobowych),
                </li>
                <li>
