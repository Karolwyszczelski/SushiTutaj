...
<div className="fixed inset-x-0 bottom-0 z-[70] lg:hidden">
  <div className="bg-gradient-to-t from-[#0b0b0b] via-[#0b0b0b] to-transparent pt-6">
    <div className="mx-auto max-w-5xl px-5 pb-[calc(env(safe-area-inset-bottom)+24px)]">
      <button
        onClick={nextStep}
...
<div className="fixed inset-x-0 bottom-0 z-[70] lg:hidden">
  <div className="bg-gradient-to-t from-[#0b0b0b] via-[#0b0b0b] to-transparent pt-6">
    <div className="mx-auto max-w-5xl px-5 pb-[calc(env(safe-area-inset-bottom)+24px)] space-y-3">
      {/* Pałeczki */}
